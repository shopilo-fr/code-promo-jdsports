#!/usr/bin/env python3
"""
Recuperation des codes promo JD Sports depuis shopilo.fr
Sursa: https://shopilo.fr/reductions/jdsports.fr
"""
...
SHOPILO_URL = "https://shopilo.fr/reductions/jdsports.fr"
STORE_NAME = "JD Sports"


def fetch_coupons(url=SHOPILO_URL):
    """Renvoie la liste des coupons actifs pour JD Sports depuis shopilo.fr"""
    headers = {
        "User-Agent": "Mozilla/5.0 (compatible; coupon-fetcher/1.0; +https://github.com/shopilo-fr/code-promo-jdsports)"
    }
    try:
